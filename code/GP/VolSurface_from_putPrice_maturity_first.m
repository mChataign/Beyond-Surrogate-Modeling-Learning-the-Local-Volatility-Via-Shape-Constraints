function surface = VolSurface_from_putPrice(S0, r, T, K, PutPrice)
%**************************************************************************
...
%
%   surface = VolSurface(S0, r, T, K, PutPrice)
%
%==========================================================================
% INPUTS: 
%
...
%   i.e. size([Maturity, Strike, PutPrice])= N x 3
%
%==========================================================================
% OUTPUTS:
%
...
ylabel('Moneyness Put $M=\frac{K}{S}$','Fontsize',20,'FontWeight','Bold','interpreter','latex');
