function H_vect = basis_func_vect(x, t, x_nodes, t_nodes)

    x_nodes_min = x_nodes.vect(1);
    x_nodes_max = x_nodes.vect(end);
    t_nodes_min = t_nodes.vect(1);
    t_nodes_max = t_nodes.vect(end);
    
    nb_nodes = x_nodes.nb * t_nodes.nb;
    ...
    [GG, HH] = meshgrid(G,H);
    H_vect =  reshape(GG.*HH, 1, nb_nodes);    
